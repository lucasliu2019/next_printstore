...
export default function About() {
  ...
  const colors = [
    ...
    { name: "PLA Basic Gradient Variant Ocean to Meadow (10902)", value: "rgb(51, 145, 159)" },
    { name: "PLA Basic Variant Yellow (10400)", value: "rgb(237, 205, 97)" },
    { name: "PLA Silk Variant Blue (13601)", value: "rgb(57, 127, 205)" },
    { name: "PLA Silk Dual Color Gilded Rose (Pink-Gold)", value: "rgb(208, 129, 100)" },
    ...
    { name: "PETG tanaleani Variant Clear (13101)", value: "rgb(200, 199, 195)" },
    ...
    { name: "PLA Matte Variant Matte Ivory White (11100)", value: "rgb(243, 242, 237)" },
